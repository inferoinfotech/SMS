...
const ViewOwner = ({ onCancel, residentDetails, images }) => {
  if (!residentDetails) return null;
  console.log("images", images);
  const { fullName, wing, unit, age, gender, members } = residentDetails;
  ...
  return (
    <div className='element-view-owner fixed inset-0 bg-black bg-opacity-50 flex justify-end items-center z-50'>
              ...
              <div className="flex z-10 flex-col mb-0 max-md:mb-2.5 max-md:max-w-full">
                <div className="flex flex-col w-full max-w-[450px] max-md:max-w-full">
                  <div className="flex gap-8 items-center self-start">
                    <div className="flex gap-2.5 justify-center items-center self-stretch px-2 my-auto w-10 h-10 border border-solid border-zinc-100 min-h-[40px] rounded-[30px] cursor-pointer" onClick={onCancel}>
                    ...
                    <div className="flex flex-col pb-4 mt-4 w-full rounded-none">
                      <div className="flex z-10 flex-col justify-center p-4 w-full text-base font-semibold text-white bg-[#5678E9] rounded-2xl rounded-b-none max-md:max-w-full">
                        <div className="flex gap-10 justify-between items-center">
                          <div className="self-stretch my-auto">Member Counting</div>
                          <div className="self-stretch my-auto">{members ? members.length.toString().padStart(2, '0') : '00'}</div>
                        </div>
                      </div>
                        ...
                        <div className="flex z-10 flex-col mx-4 mt-0 text-sm max-md:mx-2.5">
                          {members && members.length > 0 ? (
                            members.map((member, index) => (
                              <div key={index} className="flex flex-col justify-center p-2.5 max-w-full bg-white rounded-2xl shadow-2xl w-[420px] mt-4 first:mt-0">
