...
const ViewTracking = ({ complaint, onClose }) => {
  if (!complaint) return null;

  const profileImage = complaint.profileImage || profile;
  const [wing, unit] = complaint.unit.split(' ');

  return (
    <div className="element-view-tracking-pop-up fixed right-4 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="frame-479">
        <div className="frame-480">
          <div className="frame-476">
            <div className="frame-481">
              <div className="text-wrapper-285">View Tracking</div>
              <svg onClick={onClose}
          ...
          <div className="frame-482">
            <div className="frame-483">
              ...
              <div className="frame-434">
                <div className="text-wrapper-286">{complaint.requestName}</div>
                <div className="text-wrapper-287">{complaint.date}</div>
              </div>
            </div>
            <div className="frame-480">
              <div className="frame-484">
                <div className="text-wrapper-260">Request Name</div>
                <div className="text-wrapper-288">{complaint.requesterName}</div>
              </div>
              <div className="frame-484">
