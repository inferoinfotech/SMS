...
const AsideBar = ({ isVisible, onClose }) => {
        ...
        <div className="frame-52">
          ...
          {role === "admin" && (
            <>
              ...
              <Link
                className={`group-29 ${isActive("/residentManagementScreen") ? "active-tab" : ""
                  }`}
              ...
              <div
                className={`second-div ${openDropdown === "financialManagement" ? "dropdown-open" : ""
                  } group-29 ${isActive("/financialManagement") || openDropdown === "financialManagement"
                    ? "active-tab"
                    : ""
                  }`}
              ...
              >
                <Link to="/maintenanceDetail">
                  <div
                    className={`group-32 ${isActive("/financialManagement") || openDropdown === "financialManagement"
                        ? "active-tab"
                        : ""
                      }`}
                  >
                    ...
                    <button className="dropdown-toggle">
                      <span
                        className={`icon ${openDropdown === "financialManagement" ? "rotate-up" : "rotate-down"
                          }`}
                      >
                ...
                <div
                  className={`dropdown-menu-1 ${openDropdown === "financialManagement" ? "open" : ""
                    }`}
                  onClick={handleDropdownItemClick}
                >
                  <Link
                    className={`dropdown-item ${isActive("/maintenanceDetail") ? "bold-text" : ""
                      } hover:bg-gray-100 hover:text-gray-800 transition-transform duration-300 hover:scale-105`}
                  ...
                  <Link
                    className={`dropdown-item ${isActive("/expanse") ? "bold-text" : ""
                      } hover:bg-gray-100 hover:text-gray-800 transition-transform duration-300 hover:scale-105`}
                    to="/expanse"
                    onClick={handleLinkClick}
                  >
                  ...
                  <Link
                    className={`dropdown-item ${isActive("/financialNote") ? "bold-text" : ""
                      } hover:bg-gray-100 hover:text-gray-800 transition-transform duration-300 hover:scale-105`}
                    to="/financialNote"
                    onClick={handleLinkClick}
                  >
              ...
              <Link
                className={`group-29 ${isActive("/facilityManagement") ? "active-tab" : ""
                  }`}
  ...
  className={`second-div-complaint ${
    openDropdown === "complaintTracking" ? "dropdown-open-complaint" : ""
  } group-29 ${
    isActive("/complaintTracking") || openDropdown === "complaintTracking"
      ? "active-tab"
      : ""
  }`}
  ...
  <Link to="/createComplain">
    ...
    >
      ...
      <button className="dropdown-toggle">
        <span
          className={`icon-1 ${
            openDropdown === "financialManagement" ? "rotate-up" : "rotate-down"
          }`}
        >
          <img src={images.arrowDown} alt="Arrow" />
        </span>
...
<div
  className={`second-div-managment ${
    openDropdown === "securityManagement" ? "dropdown-open-managment" : ""
  } group-29 ${
    isActive("/securityManagement") || openDropdown === "securityManagement"
      ? "active-tab"
      : ""
  }`}
  ...
  >
    ...
    >
      Security Protocols
              ...
              <Link
                className={`group-29 ${isActive("/securityGuard") ? "active-tab" : ""
                  }`}
                to="/securityGuard"
                onClick={handleLinkClick}
              >
              ...
              <Link
                className={`group-29 ${isActive("/announcement") ? "active-tab" : ""
                  }`}
                to="/announcementDiv"
                onClick={handleLinkClick}
              >
          ...
          {role === "resident" && (
            <>
              ...
              <Link
                className={`group-29 ${isActive("/userPersonalDetail") ? "active-tab" : ""
                  }`}
              ...
              <Link
                className={`group-29 ${isActive("/serviceAndComplaint") ? "active-tab" : ""
                  }`}
              ...
              <Link
                className={`group-29 ${isActive("/userFacilityManagementScreen") ? "active-tab" : ""
                  }`}
              ...
              <Link
                className={`group-29 ${isActive("/eventParticipation") ? "active-tab" : ""
                  }`}
...
>
  <Link to="/chatScreen">
    ...
    >
      ...
      <button className="dropdown-toggle">
        <span
          className={`icon-1 ${
            openDropdown === "paymentPortal" ? "rotate-up" : "rotate-down"
          }`}
        >
          <img src={images.arrowDown} alt="Arrow" />
        </span>
  ...
  >
    <Link
      ...
      } hover:bg-gray-100 hover:text-gray-800 hover:font-semibold transition-transform duration-300 hover:scale-105 rounded-md`}
      to="/chatScreen"
      onClick={handleLinkClick}
    >
      Access Forums
    ...
    <Link
      className={`dropdown-item-managment ${
        isActive("/communityPoll") ? "bold-text" : ""
      } hover:bg-gray-100 hover:text-gray-800 hover:font-semibold transition-transform duration-300 hover:scale-105 rounded-md`}
      to="/communityPoll"
      onClick={handleLinkClick}
    >
    ...
    <Link
      className={`dropdown-item-managment ${
        isActive("/communityDiscussionScreen") ? "bold-text" : ""
      } hover:bg-gray-100 hover:text-gray-800 hover:font-semibold transition-transform duration-300 hover:scale-105 rounded-md`}
...
>
  ...
  >
    ...
    <Link
      className={`dropdown-item-managment ${
        isActive("/otherInvoice") ? "bold-text" : ""
      } hover:bg-gray-100 hover:text-gray-800 hover:font-semibold transition-transform duration-300 hover:scale-105 rounded-md`}
      to="/otherInvoice"
      onClick={handleLinkClick}
    >
      Other Invoice
              ...
              <Link
                className={`group-29 ${isActive("/securityProtocolsScreen") ? "active-tab" : ""
                  }`}
          ...
          {role === "security" && (
            <>
              <div
                className={`second-div-managment ${openDropdown === "Security" ? "dropdown-open-managment" : ""
                  } group-29 ${isActive("/visitortrackingScreen") || openDropdown === "Security"
                    ? "active-tab"
                    : ""
                  }`}
              ...
              >
                <Link to="/visitortrackingScreen">
                  <div
                    className={`group-32 ${isActive("/visitortrackingScreen") || openDropdown === "Security"
                        ? "active-tab"
                        : ""
                      }`}
                  >
                    ...
                    <button className="dropdown-toggle">
                      <span
                        className={`icon-1 ${openDropdown === "Security"
                            ? "rotate-up"
                            : "rotate-down"
                          }`}
                      >
                ...
                <div
                  className={`dropdown-menu-managment ${openDropdown === "Security" ? "open" : ""
                    }`}
                  onClick={handleDropdownItemClick}
                >
                  <Link
                    className={`dropdown-item-managment ${isActive("/visitortrackingScreen") ? "bold-text" : ""
                      }`}
